...
void initialize(int marks_a[10][5], int size_f);
...
int main()
{
	...
	// Calling initializing function to prevent errors
	initialize(marks, size);
...
// Initialize Function to assign the default 0 to all index of marks array.
void initialize(int marks_a[10][5], int size_f) {
